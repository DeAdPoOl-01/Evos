...
TOKEN = "8025359791:AAHw7ufRdYeHHXgKHew9Y1ArB5XaOOYvPrs"
channel_name = "@"
...
async def start(message: types.Message):
    ...
    await message.answer("Assalomu alaykum! \n Evos yetkazib berish xizmatiga xush kelibsiz.\n\n"
                             "Здравствуйте! Добро пожаловать в службу доставки Evos.\n\n"
                             "Hello! Welcome to Evos delivery service.", reply_markup=keyboard)
    print(user_data)
...
async def shu_yerda(message: types.Message):
    ...
    keyboard = types.InlineKeyboardMarkup(inline_keyboard=button, resize_keyboard=True)
    await message.answer("O'z joylashuvingiz bilan buyurtma bering - https://evos.uz/", reply_markup=keyboard)
    print(user_data)
